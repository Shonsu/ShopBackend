...
import pl.shonsu.shop.admin.order.service.AdminExportService;
...
public class AdminOrderExportController {
    ...
    public ResponseEntity<Resource> exportOrders(
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "orderExport.csv") //  .header("Content-Disposition", "attachment; filename=" + resourceName)
    ...
    private ByteArrayInputStream transformToCsv(List<AdminOrder> adminOrders) {
        try (ByteArrayOutputStream stream = new ByteArrayOutputStream();
            ...
            throw new RuntimeException("Błąd przetwarzana CSV: " + e.getMessage());
        }
    }
}
